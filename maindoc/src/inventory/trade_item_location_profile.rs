...
/// UBL 2.5 TradeItemLocationProfile document type.
/// Profile of item location data.
...
pub struct TradeItemLocationProfile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile_status_code: Option<ubl_common::cbc::ProfileStatusCode>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub item_management_profile: Vec<ItemManagementProfile>,
}
...
/// UBL 2.5 ItemManagementProfile — real field definitions from UBL 2.5 CAC schema
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
