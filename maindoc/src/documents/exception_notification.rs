...
/// A document used to notify an exception in forecast variance, product activity, or performance
/// history.
///
...
/// The period of time during which the exceptions are observed.
    ...
    pub exception_observation_period: cac::Period,
...
/// A line in the Exception Notification.
    ...
    pub exception_notification_line: Vec<cac::ExceptionNotificationLine>,
}
