...
/// A document used to initiate a return of goods. The producer is requesting the return of products
/// that are not selling well, either to use in other places or to free up rack or shelf space.
///
...
/// The Party that manufactures the goods to which this Instruction for Return applies.
    #[serde(default, rename = "ManufacturerParty")]
    pub manufacturer_party: Option<cac::Party>,
/// The shipment.
...
/// A line providing details about one type of article to be returned.
    ...
    pub instruction_for_returns_line: Vec<cac::InstructionForReturnsLine>,
}
