...
/// A document used to update information (e.g., technical descriptions and properties) about Items in
...
/// The Party who sends the Catalogue Item Specification Update.
    #[serde(rename = "ProviderParty")]
    pub provider_party: cac::Party,
/// The Party who receives the Catalogue Item Specification Update.
...
/// One or more lines in the Catalogue Item Specification Update, each line updating a specific
/// catalogue item.
