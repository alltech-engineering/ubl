...
pub struct RemittanceAdvice {
    ...
    pub total_debit_amount: Option<cct::AmountType>,
    #[serde(default, rename = "TotalCreditAmount")]
    pub total_credit_amount: Option<cct::AmountType>,
    #[serde(default, rename = "TotalPaymentAmount")]
    pub total_payment_amount: Option<cct::AmountType>,
    #[serde(default, rename = "PaymentOrderReference")]
    pub payment_order_reference: Option<cct::TextType>,
    #[serde(default, rename = "PayerReference")]
    pub payer_reference: Option<cct::TextType>,
    #[serde(default, rename = "InvoicingPartyReference")]
    pub invoicing_party_reference: Option<cct::TextType>,
