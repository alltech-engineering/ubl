...
/// A code signifying the status of the Despatch Advice with respect to its original state. This code
/// may be used if the document precedes the event and is subsequently found to be incorrect and in need
...
/// A code signifying the type of the Despatch Advice.
    ...
    pub despatch_advice_type_code: Option<cct::Code>,
