...
pub struct PurchaseReceipt {
    ...
    pub transaction_date: Option<udt::DateTimeType>,
    #[serde(default, rename = "TransactionTime")]
    pub transaction_time: Option<udt::DateTimeType>,
    #[serde(default, rename = "PurchaseDate")]
    pub purchase_date: Option<udt::DateTimeType>,
    #[serde(default, rename = "PurchaseTime")]
    pub purchase_time: Option<udt::DateTimeType>,
