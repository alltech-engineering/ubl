...
/// A reference to an additional document associated with this document. It can be used to include annex
/// documents such as the minutes of the awarding process meetings.
