...
/// A document used by a contracting party to declare the intention to buy goods, services, or works
...
/// An identifier of the previous version of the Prior Information Notice which is superceded by this
/// version.
