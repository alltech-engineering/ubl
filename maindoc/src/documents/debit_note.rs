...
/// The date on which this Debit Note is due.
...
/// A code signifying the type of the Debit Note.
    #[serde(default, rename = "DebitNoteTypeCode")]
    pub debit_note_type_code: Option<cct::Code>,
...
/// etc., to which this Debit Note relates.
    #[serde(default, rename = "PurchaseReference")]
    pub purchase_reference: Vec<cac::PurchaseReference>,
/// A structured annotation providing contextual or explanatory information related to this Debit Note.
...
/// The Party authorized to act as the Tax Representative for this Debit Note.
...
/// The total amount payable on the Debit Note, including allowances, charges, and taxes.
    ...
    pub requested_monetary_total: Option<cac::MonetaryTotal>,
/// The total amount payable on the Debit Note, including allowances, charges, and taxes.
...
/// A line describing an item or amount collected on behalf of a third party.
    ...
    pub collection_debit_note_line: Vec<cac::DebitNoteLine>,
/// A Debit Note line.
    #[serde(default, rename = "DebitNoteLine")]
    pub debit_note_line: Vec<cac::DebitNoteLine>,
}
