...
pub struct ReceiptAdvice {
    ...
    pub receipt_advice_type_code: Option<cct::CodeType>,
    #[serde(default, rename = "DeliveryAcceptanceCode")]
    pub delivery_acceptance_code: Option<cct::CodeType>,
    #[serde(default, rename = "RejectReasonCode")]
    pub reject_reason_code: Option<cct::CodeType>,
    #[serde(default, rename = "RejectReason")]
    pub reject_reason: Vec<cct::TextType>,
    #[serde(default, rename = "RejectActionCode")]
    pub reject_action_code: Option<cct::CodeType>,
