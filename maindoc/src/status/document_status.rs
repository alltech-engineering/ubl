...
/// UBL 2.5 DocumentStatus document type.
/// Status of a previously sent document.
...
pub struct DocumentStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub document_response: Option<ubl_common::cac::DocumentResponse>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub additional_document_response: Vec<AdditionalDocumentResponse>,
}
...
/// UBL 2.5 AdditionalDocumentResponse — real field definitions from UBL 2.5 CAC schema
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AdditionalDocumentResponse {
    #[serde(default, skip_serializing_if = "Option::is_none")]
