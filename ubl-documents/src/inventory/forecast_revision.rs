...
/// UBL 2.5 ForecastRevision document type.
/// A revised demand or supply forecast.
...
pub struct ForecastRevision {
    ...
    pub sequence_number_id: ubl_common::cbc::SequenceNumberID,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub revision_status_code: Option<ubl_common::cbc::RevisionStatusCode>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub purpose_code: Option<ubl_common::cbc::PurposeCode>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub forecast_revision_line: Vec<ForecastRevisionLine>,
}
...
/// UBL 2.5 ForecastRevisionLine — real field definitions from UBL 2.5 CAC schema
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
