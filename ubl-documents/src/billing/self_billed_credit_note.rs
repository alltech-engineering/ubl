// UBL SelfBilledCreditNote — a credit note issued by the buyer.
// UBL element: SelfBilledCreditNote (CreditNoteType — same schema as CreditNote)
//
// Reference: UBL 2.5 XSD maindoc/UBL-SelfBilledCreditNote-2.5.xsd
//
// Structurally identical to CreditNote. The semantic distinction (buyer-issued)
// is captured by the type name.
...
/// A credit note issued by the buyer. Structurally identical to CreditNote.
