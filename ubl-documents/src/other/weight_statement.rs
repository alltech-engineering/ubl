...
/// UBL 2.5 WeightStatement document type.
/// Weight certificate for goods.
...
pub struct WeightStatement {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub weight_statement_type_code: Option<ubl_common::cbc::WeightStatementTypeCode>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub signature: Vec<ubl_common::cac::Signature>,
    pub sender_party: SenderParty,
    pub receiver_party: ReceiverParty,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub weighing_party: Option<WeighingParty>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shipper_party: Option<ShipperParty>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// UBL WeighingParty — a Party playing this specific role.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct WeighingParty {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub party: Option<ubl_common::cac::Party>,
    // TODO: Add role-specific fields from UBL 2.5 CAC schema
}

/// UBL ShipperParty — a Party playing this specific role.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ShipperParty {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub party: Option<ubl_common::cac::Party>,
    // TODO: Add role-specific fields from UBL 2.5 CAC schema
}

/// UBL ResponsibleParty — a Party playing this specific role.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
