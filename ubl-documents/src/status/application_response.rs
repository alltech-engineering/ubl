...
/// UBL 2.5 ApplicationResponse document type.
/// A response to any business document — acknowledges receipt, accepts, or rejects.
...
pub struct ApplicationResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub response_date: Option<ubl_common::cbc::ResponseDate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub response_time: Option<ubl_common::cbc::ResponseTime>,
