...
pub fn invoice_type_codes() -> CodeList {
    CodeList::new(
        ...
        vec![
            ...
            CodeEntry {
                code: "381".into(),
                name: "Credit Note".into(),
                description: None,
            },
            CodeEntry {
                code: "383".into(),
                name: "Debit Note".into(),
                description: None,
            },
            CodeEntry {
                code: "384".into(),
                name: "Corrected Invoice".into(),
                description: None,
            },
            CodeEntry {
                code: "386".into(),
                name: "Prepayment Invoice".into(),
                description: None,
            },
            CodeEntry {
                code: "388".into(),
                name: "Tax Invoice".into(),
                description: None,
            },
            CodeEntry {
                code: "389".into(),
                name: "Self-billed Invoice".into(),
                description: None,
            },
            CodeEntry {
                code: "395".into(),
                name: "Consolidated Invoice".into(),
                description: None,
            },
        ],
    )
...
pub fn tax_category_codes() -> CodeList {
    CodeList::new(
        "UNCL5305-TaxCategory",
        vec![
            CodeEntry {
                code: "S".into(),
                name: "Standard Rate".into(),
                description: None,
            },
            CodeEntry {
                code: "Z".into(),
                name: "Zero Rated".into(),
                description: None,
            },
            CodeEntry {
                code: "E".into(),
                name: "Exempt from Tax".into(),
                description: None,
            },
            CodeEntry {
                code: "AE".into(),
                name: "VAT Reverse Charge".into(),
                description: None,
            },
            CodeEntry {
                code: "K".into(),
                name: "VAT exempt for intra-community supply".into(),
                description: None,
            },
            CodeEntry {
                code: "G".into(),
                name: "Free export item, tax not charged".into(),
                description: None,
            },
            CodeEntry {
                code: "O".into(),
                name: "Services outside scope of tax".into(),
                description: None,
            },
            CodeEntry {
                code: "L".into(),
                name: "Canary Islands general indirect tax".into(),
                description: None,
            },
            CodeEntry {
                code: "M".into(),
                name: "Tax for production, services and importation in Ceuta and Melilla".into(),
                description: None,
            },
        ],
    )
...
pub fn payment_means_codes() -> CodeList {
    CodeList::new(
        "UNCL4461-PaymentMeans",
        vec![
            CodeEntry {
                code: "1".into(),
                name: "Instrument not defined".into(),
                description: None,
            },
            CodeEntry {
                code: "10".into(),
            ...
            CodeEntry {
                code: "30".into(),
                name: "Credit transfer".into(),
                description: None,
            },
            CodeEntry {
                code: "31".into(),
                name: "Debit transfer".into(),
                description: None,
            },
            CodeEntry {
                code: "42".into(),
                name: "Payment to bank account".into(),
                description: None,
            },
            CodeEntry {
                code: "48".into(),
            ...
            CodeEntry {
                code: "49".into(),
                name: "Direct debit".into(),
                description: None,
            },
            CodeEntry {
                code: "58".into(),
                name: "SEPA credit transfer".into(),
                description: None,
            },
            CodeEntry {
                code: "59".into(),
                name: "SEPA direct debit".into(),
                description: None,
            },
        ],
    )
...
pub fn uncl2005_codes() -> CodeList {
    CodeList::new(
        "UNCL2005-DateTimePeriodQualifier",
        vec![
            CodeEntry {
                code: "3".into(),
                name: "Invoice period".into(),
                description: None,
            },
            CodeEntry {
                code: "35".into(),
                name: "Delivery date/time, actual".into(),
                description: None,
            },
            CodeEntry {
                code: "432".into(),
                name: "Paid to date".into(),
                description: None,
            },
        ],
    )
...
pub fn currency_codes() -> CodeList {
    CodeList::new(
        ...
        vec![
            ...
            CodeEntry {
                code: "DKK".into(),
                name: "Danish Krone".into(),
                description: None,
            },
            CodeEntry {
                code: "SEK".into(),
                name: "Swedish Krona".into(),
                description: None,
            },
            CodeEntry {
                code: "NOK".into(),
                name: "Norwegian Krone".into(),
                description: None,
            },
            CodeEntry {
                code: "CHF".into(),
            ...
            CodeEntry {
                code: "AUD".into(),
                name: "Australian Dollar".into(),
                description: None,
            },
            CodeEntry {
                code: "NZD".into(),
                name: "New Zealand Dollar".into(),
                description: None,
            },
            CodeEntry {
                code: "CAD".into(),
            ...
            CodeEntry {
                code: "PLN".into(),
                name: "Polish Zloty".into(),
                description: None,
            },
            CodeEntry {
                code: "CZK".into(),
                name: "Czech Koruna".into(),
                description: None,
            },
            CodeEntry {
                code: "HUF".into(),
                name: "Hungarian Forint".into(),
                description: None,
            },
            CodeEntry {
                code: "BGN".into(),
                name: "Bulgarian Lev".into(),
                description: None,
            },
            CodeEntry {
                code: "RON".into(),
                name: "Romanian Leu".into(),
                description: None,
            },
        ],
    )
