...
define_code!(
    CreditNoteTypeCode,
    "A code specifying the type of credit note."
);
define_code!(
    DebitNoteTypeCode,
    "A code specifying the type of debit note."
);
define_code!(OrderTypeCode, "A code specifying the type of order.");
define_code!(
    OrderResponseCode,
    "A code specifying the response to an order."
);
define_code!(
    DespatchAdviceTypeCode,
    "A code specifying the type of despatch advice."
);
define_code!(
    ReceiptAdviceTypeCode,
    "A code specifying the type of receipt advice."
);
define_code!(DocumentTypeCode, "A code specifying a document type.");
define_code!(ResponseCode, "A code specifying a response.");
define_code!(
    LineStatusCode,
    "A code specifying the status of a document line."
);
define_code!(TenderTypeCode, "A code specifying the type of tender.");
define_code!(
    CatalogueTypeCode,
    "A code specifying the type of catalogue."
);
define_code!(ContractTypeCode, "A code specifying the type of contract.");
define_code!(
    StatementTypeCode,
    "A code specifying the type of statement."
);
define_code!(ReminderTypeCode, "A code specifying reminder type.");
define_code!(
    RemittanceAdviceTypeCode,
    "A code specifying remittance advice type."
);
define_code!(
    ModificationReasonCode,
    "A code specifying the reason for a modification."
);
...
define_code!(
    AgreementTypeCode,
    "A code specifying the type of agreement."
);
define_code!(
    RequiredResponseMessageLevelCode,
    "A code specifying the required response message level."
);
define_code!(
    WasteMovementTypeCode,
    "A code specifying the type of waste movement."
);
define_code!(
    WasteNotificationTypeCode,
    "A code specifying the type of waste notification."
);
define_code!(
    WeightStatementTypeCode,
    "A code specifying the type of weight statement."
);

// Industry standard codes
define_code!(
    CurrencyCode,
    "An ISO 4217 currency code (e.g., EUR, USD, ZAR)."
);
...
define_code!(
    TransportModeCode,
    "A code specifying the mode of transport."
);
define_code!(
    TransportMeansTypeCode,
    "A code specifying the type of transport means."
);
define_code!(PaymentMeansCode, "A code specifying the means of payment.");
define_code!(
    PaymentPurposeCode,
    "A code specifying the purpose of a payment."
);
define_code!(TaxTypeCode, "A code specifying the type of tax.");
define_code!(TaxLevelCode, "A code specifying a tax level.");
define_code!(
    TaxExemptionReasonCode,
    "A code specifying the reason for tax exemption."
);
define_code!(
    AllowanceChargeReasonCode,
    "A code specifying the reason for an allowance or charge."
);
define_code!(
    CommodityCode,
    "A code specifying a commodity classification (e.g., HS code)."
);
define_code!(
    ItemClassificationCode,
    "A code specifying an item classification."
);
define_code!(CargoTypeCode, "A code specifying the type of cargo.");
define_code!(DangerousGoodsCode, "A UNDG dangerous goods code.");
define_code!(
    PackagingTypeCode,
    "A code specifying the type of packaging."
);
...
define_code!(
    ActionCode,
    "A code specifying an action (add, change, delete)."
);
...
define_code!(
    ...
    "A code specifying feature tactic type."
);
define_code!(
    FinancingInstrumentCode,
    "A code specifying a financing instrument."
);
...
define_code!(
    ...
    "A code specifying hazardous category."
);
define_code!(
    HazardousRegulationCode,
    "A code specifying hazardous regulation."
);
...
define_code!(
    ...
    "A code for industry classification."
);
define_code!(
    InhalationToxicityZoneCode,
    "A code specifying inhalation toxicity zone."
);
...
define_code!(
    ...
    "A code specifying latitude direction (N/S)."
);
...
define_code!(
    ...
    "A code specifying longitude direction (E/W)."
);
define_code!(MandateTypeCode, "A code specifying mandate type.");
define_code!(
    MathematicOperatorCode,
    "A code specifying a mathematical operator."
);
define_code!(
    MedicalFirstAidGuideCode,
    "A code specifying medical first aid guide."
);
define_code!(
    MeterReadingTypeCode,
    "A code specifying meter reading type."
);
define_code!(
    NatureOfTransactionCode,
    "A code specifying nature of transaction."
);
define_code!(OptionTypeCode, "A code specifying option type.");
define_code!(
    OrganizationDepartmentCode,
    "A code specifying an organization department."
);
define_code!(
    OutstandingReasonCode,
    "A code specifying outstanding reason."
);
...
define_code!(
    ...
    "A code specifying packaging danger level."
);
...
define_code!(
    ...
    "A code specifying procurement sub-type."
);
...
define_code!(
    ...
    "A security classification code."
);
define_code!(
    ServiceInformationPreferenceCode,
    "A service information preference code."
);
...
define_code!(
    SpecialTransportRequirementsCode,
    "A special transport requirements code."
);
...
define_code!(
    ...
    "A supply chain activity type code."
);
...
define_code!(
    ...
    "A trade item packing labeling type code."
);
...
define_code!(
    ...
    "A transport authorization code."
);
define_code!(
    TransportEmergencyCardCode,
    "A transport emergency card code."
);
define_code!(
    TransportEquipmentTypeCode,
    "A transport equipment type code."
);
define_code!(TransportEventTypeCode, "A transport event type code.");
define_code!(
    TransportHandlingUnitTypeCode,
    "A transport handling unit type code."
);
define_code!(TransportServiceCode, "A transport service code.");
define_code!(
    TransportationServiceDescriptionCode,
    "A transportation service description code."
);
define_code!(
    TransportationStatusTypeCode,
    "A transportation status type code."
);
...
define_code!(
    DocumentStatusCode,
    "A code specifying the status of a document."
);
define_code!(
    RejectActionCode,
    "A code specifying the action to take on rejection."
);
define_code!(
    StatusReasonCode,
    "A code specifying the reason for a status."
);
...
define_code!(
    NoticeLanguageCode,
    "A code specifying the language of a notice."
);
define_code!(
    QualificationApplicationTypeCode,
    "A code specifying the qualification application type."
);
define_code!(
    WeightingTypeCode,
    "A code specifying the type of weighting."
);
define_code!(
    TenderLanguageLocaleCode,
    "A locale code for tender language."
);
define_code!(
    PreferredLanguageLocaleCode,
    "A locale code for preferred language."
);

// --- Currency code variants used by document types ---
define_code!(
    DocumentCurrencyCode,
    "A code signifying the default currency for a document."
);
define_code!(
    PricingCurrencyCode,
    "A code signifying the currency used for prices in a document."
);
define_code!(
    PaymentCurrencyCode,
...
define_code!(
    DefaultLanguageCode,
    "A code signifying the default natural language for a document."
);
define_code!(
    DiscrepancyResponseCode,
    "A code specifying the response to a discrepancy."
);
...
define_code!(
    ApplicableCategoryCode,
    "UBL CBC type: ApplicableCategoryCode."
);
define_code!(
    ApplicationStatusCode,
    "UBL CBC type: ApplicationStatusCode."
);
define_code!(
    AvailabilityStatusCode,
    "UBL CBC type: AvailabilityStatusCode."
);
define_code!(
    AwardingCriterionTypeCode,
    "UBL CBC type: AwardingCriterionTypeCode."
);
define_code!(
    AwardingMethodTypeCode,
    "UBL CBC type: AwardingMethodTypeCode."
);
define_code!(BuyerReferenceCode, "UBL CBC type: BuyerReferenceCode.");
define_code!(
    CalculationExpressionCode,
    "UBL CBC type: CalculationExpressionCode."
);
define_code!(
    CalculationMethodCode,
    "UBL CBC type: CalculationMethodCode."
);
...
define_code!(
    ...
    "UBL CBC type: ContractingSystemCode."
);
define_code!(
    ContractingSystemTypeCode,
    "UBL CBC type: ContractingSystemTypeCode."
);
...
define_code!(
    ...
    "UBL CBC type: FulfilmentIndicatorTypeCode."
);
define_code!(
    FullnessIndicationCode,
    "UBL CBC type: FullnessIndicationCode."
);
...
define_code!(
    ...
    "UBL CBC type: MiscellaneousEventTypeCode."
);
...
define_code!(
    ...
    "UBL CBC type: PreviousCancellationReasonCode."
);
define_code!(
    PreviousMeterReadingMethodCode,
    "UBL CBC type: PreviousMeterReadingMethodCode."
);
...
define_code!(
    ...
    "UBL CBC type: PropertyGroupTypeCode."
);
...
define_code!(
    ...
    "UBL CBC type: RepresentationTypeCode."
);
define_code!(
    RequiredCurriculaCode,
    "UBL CBC type: RequiredCurriculaCode."
);
define_code!(ResourceTypeCode, "UBL CBC type: ResourceTypeCode.");
define_code!(
    SanitaryMeasureTypeCode,
    "UBL CBC type: SanitaryMeasureTypeCode."
);
...
define_code!(
    ...
    "UBL CBC type: TelecommunicationsServiceCallCode."
);
define_code!(
    TelecommunicationsServiceCategoryCode,
    "UBL CBC type: TelecommunicationsServiceCategoryCode."
);
define_code!(
    TelecommunicationsSupplyTypeCode,
    "UBL CBC type: TelecommunicationsSupplyTypeCode."
);
define_code!(
    TendererRequirementTypeCode,
    "UBL CBC type: TendererRequirementTypeCode."
);
define_code!(TendererRoleCode, "UBL CBC type: TendererRoleCode.");
define_code!(
    ThresholdValueComparisonCode,
    "UBL CBC type: ThresholdValueComparisonCode."
);
...
define_code!(
    ...
    "UBL CBC type: TransportExecutionStatusCode."
);
define_code!(TreatmentPathwayCode, "UBL CBC type: TreatmentPathwayCode.");
define_code!(
    TunnelRestrictionCode,
    "UBL CBC type: TunnelRestrictionCode."
);
