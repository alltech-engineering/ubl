...
pub struct ShipmentStage {
    ...
    pub shipment_stage_type_code: Option<super::cct::CodeType>,
    #[serde(default, rename = "ShipmentStageType")]
    pub shipment_stage_type: Vec<super::cct::TextType>,
    #[serde(default, rename = "TransportModeCode")]
    pub transport_mode_code: Option<super::cct::CodeType>,
    ...
    pub transit_direction_code: Option<super::cct::CodeType>,
    #[serde(default, rename = "PreCarriageIndicator")]
    pub pre_carriage_indicator: Option<super::udt::IndicatorType>,
    #[serde(default, rename = "OnCarriageIndicator")]
    pub on_carriage_indicator: Option<super::udt::IndicatorType>,
    #[serde(default, rename = "CabotageIndicator")]
    pub cabotage_indicator: Option<super::udt::IndicatorType>,
    ...
    pub estimated_delivery_date: Option<super::udt::DateTimeType>,
    #[serde(default, rename = "EstimatedDeliveryTime")]
    pub estimated_delivery_time: Option<super::udt::DateTimeType>,
    #[serde(default, rename = "RequiredDeliveryDate")]
    pub required_delivery_date: Option<super::udt::DateTimeType>,
    #[serde(default, rename = "RequiredDeliveryTime")]
    pub required_delivery_time: Option<super::udt::DateTimeType>,
    ...
    pub successive_sequence_id: Option<super::cct::IdentifierType>,
    #[serde(default, rename = "Instructions")]
    pub instructions: Vec<super::cct::TextType>,
    #[serde(default, rename = "DemurrageInstructions")]
    pub demurrage_instructions: Vec<super::cct::TextType>,
    #[serde(default, rename = "CrewQuantity")]
    pub crew_quantity: Option<super::cct::QuantityType>,
    #[serde(default, rename = "PassengerQuantity")]
    pub passenger_quantity: Option<super::cct::QuantityType>,
    #[serde(default, rename = "TransitPeriod")]
    pub transit_period: Option<Period>,
    #[serde(default, rename = "CarrierParty")]
    pub carrier_party: Vec<Party>,
    #[serde(default, rename = "TransportMeans")]
    pub transport_means: Option<TransportMeans>,
    #[serde(default, rename = "LoadingPortLocation")]
    pub loading_port_location: Option<Location>,
    #[serde(default, rename = "UnloadingPortLocation")]
    pub unloading_port_location: Option<Location>,
    #[serde(default, rename = "TransshipPortLocation")]
    pub transship_port_location: Option<Location>,
    #[serde(default, rename = "LoadingTransportEvent")]
    pub loading_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "ExaminationTransportEvent")]
    pub examination_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "AvailabilityTransportEvent")]
    pub availability_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "ExportationTransportEvent")]
    pub exportation_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "DischargeTransportEvent")]
    pub discharge_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "WarehousingTransportEvent")]
    pub warehousing_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "TakeoverTransportEvent")]
    pub takeover_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "OptionalTakeoverTransportEvent")]
    pub optional_takeover_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "DropoffTransportEvent")]
    pub dropoff_transport_event: Option<TransportEvent>,
    ...
    pub delivery_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "ReceiptTransportEvent")]
    pub receipt_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "StorageTransportEvent")]
    pub storage_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "AcceptanceTransportEvent")]
    pub acceptance_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "TerminalOperatorParty")]
    pub terminal_operator_party: Option<Party>,
    #[serde(default, rename = "CustomsAgentParty")]
    pub customs_agent_party: Option<Party>,
    #[serde(default, rename = "EstimatedTransitPeriod")]
    pub estimated_transit_period: Option<Period>,
    ...
    pub freight_charge_location: Option<Location>,
    #[serde(default, rename = "DetentionTransportEvent")]
    pub detention_transport_event: Vec<TransportEvent>,
    #[serde(default, rename = "RequestedDepartureTransportEvent")]
    pub requested_departure_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "RequestedArrivalTransportEvent")]
    pub requested_arrival_transport_event: Option<TransportEvent>,
    #[serde(default, rename = "RequestedWaypointTransportEvent")]
    pub requested_waypoint_transport_event: Vec<TransportEvent>,
    ...
    pub planned_waypoint_transport_event: Vec<TransportEvent>,
    ...
    pub actual_waypoint_transport_event: Option<TransportEvent>,
