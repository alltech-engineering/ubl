...
pub struct TransportExecutionTerms {
    ...
    pub transport_user_special_terms: Vec<super::cct::TextType>,
    #[serde(default, rename = "TransportServiceProviderSpecialTerms")]
    pub transport_service_provider_special_terms: Vec<super::cct::TextType>,
    #[serde(default, rename = "ChangeConditions")]
    pub change_conditions: Vec<super::cct::TextType>,
    ...
    pub bonus_payment_terms: Option<PaymentTerms>,
    #[serde(default, rename = "CommissionPaymentTerms")]
    pub commission_payment_terms: Option<PaymentTerms>,
    #[serde(default, rename = "PenaltyPaymentTerms")]
    pub penalty_payment_terms: Option<PaymentTerms>,
    ...
    pub notification_requirement: Vec<NotificationRequirement>,
    #[serde(default, rename = "ServiceChargePaymentTerms")]
    pub service_charge_payment_terms: Option<PaymentTerms>,
}
