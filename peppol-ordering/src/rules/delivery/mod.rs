...
pub fn add_rules(engine: &mut RuleEngine, inv: &Arc<Order>) {
    ...
    engine.add_rule(ord_r034::rule(inv));
    engine.add_rule(ord_r035::rule(inv));
    engine.add_rule(ord_r036::rule(inv));
    engine.add_rule(ord_r037::rule(inv));
    engine.add_rule(ord_r038::rule(inv));
    engine.add_rule(ord_r039::rule(inv));
}
