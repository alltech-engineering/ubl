...
define_indicator!(
    CopyIndicator,
    "Whether this is a copy of the original document."
);
define_indicator!(
...
define_indicator!(
    ...
    "Whether an item specification update is requested."
);
define_indicator!(
...
define_indicator!(
    ...
    "Whether dangerous goods approval exists."
);
define_indicator!(
    HumanFoodIndicator,
    "Whether the item is for human consumption."
);
...
define_indicator!(
    ...
    "Whether material is returnable."
);
define_indicator!(
...
define_indicator!(
    ...
    "Whether a pricing update was requested."
);
define_indicator!(
    SmallBusinessInclusionIndicator,
    "Small business inclusion indicator."
);
define_indicator!(
...
define_indicator!(
    ...
    "Indicates whether something is free of charge (true = free)."
);
define_indicator!(
    BasedOnConsensusIndicator,
    "Whether a forecast is based on consensus."
);
define_indicator!(IndicationIndicator, "A generic indicator flag.");
define_indicator!(
    PublishAwardIndicator,
    "Whether the award should be published."
);
define_indicator!(
    WithdrawOfferIndicator,
    "Whether an offer/tender is withdrawn."
);
...
define_indicator!(
    ...
    "UBL CBC type: AnimalFoodApprovedIndicator."
);
...
define_indicator!(
    ...
    "UBL CBC type: AuctionConstraintIndicator."
);
define_indicator!(
    BalanceBroughtForwardIndicator,
    "UBL CBC type: BalanceBroughtForwardIndicator."
);
define_indicator!(
    BindingOnBuyerIndicator,
    "UBL CBC type: BindingOnBuyerIndicator."
);
define_indicator!(BuriedAtSeaIndicator, "UBL CBC type: BuriedAtSeaIndicator.");
define_indicator!(
    CandidateReductionConstraintIndicator,
    "UBL CBC type: CandidateReductionConstraintIndicator."
);
define_indicator!(
    CustomsImportClassifiedIndicator,
    "UBL CBC type: CustomsImportClassifiedIndicator."
);
define_indicator!(DiedIndicator, "UBL CBC type: DiedIndicator.");
define_indicator!(
    ElectronicCatalogueUsageIndicator,
    "UBL CBC type: ElectronicCatalogueUsageIndicator."
);
define_indicator!(
    ElectronicInvoiceAcceptedIndicator,
    "UBL CBC type: ElectronicInvoiceAcceptedIndicator."
);
define_indicator!(
    ElectronicOrderUsageIndicator,
    "UBL CBC type: ElectronicOrderUsageIndicator."
);
define_indicator!(
    ElectronicPaymentUsageIndicator,
    "UBL CBC type: ElectronicPaymentUsageIndicator."
);
define_indicator!(EvacuatedIndicator, "UBL CBC type: EvacuatedIndicator.");
define_indicator!(
    ExpectedAnchorageIndicator,
    "UBL CBC type: ExpectedAnchorageIndicator."
);
define_indicator!(ExpectedIndicator, "UBL CBC type: ExpectedIndicator.");
define_indicator!(
    FollowupContractIndicator,
    "UBL CBC type: FollowupContractIndicator."
);
define_indicator!(
    FridayAvailabilityIndicator,
    "UBL CBC type: FridayAvailabilityIndicator."
);
define_indicator!(
    FrozenDocumentIndicator,
    "UBL CBC type: FrozenDocumentIndicator."
);
define_indicator!(FulfilmentIndicator, "UBL CBC type: FulfilmentIndicator.");
define_indicator!(
    FullyPaidSharesIndicator,
    "UBL CBC type: FullyPaidSharesIndicator."
);
define_indicator!(
    FumigatedCargoTransportIndicator,
    "UBL CBC type: FumigatedCargoTransportIndicator."
);
define_indicator!(
    GeneralCargoIndicator,
    "UBL CBC type: GeneralCargoIndicator."
);
define_indicator!(
    HumanFoodApprovedIndicator,
    "UBL CBC type: HumanFoodApprovedIndicator."
);
define_indicator!(
    IMOGuidelinesOnBoardIndicator,
    "UBL CBC type: IMOGuidelinesOnBoardIndicator."
);
define_indicator!(
    InfectiousDiseaseCaseOnBoardIndicator,
    "UBL CBC type: InfectiousDiseaseCaseOnBoardIndicator."
);
define_indicator!(
    InitiatingPartyIndicator,
    "UBL CBC type: InitiatingPartyIndicator."
);
define_indicator!(
    ManagementPlanImplementedIndicator,
    "UBL CBC type: ManagementPlanImplementedIndicator."
);
define_indicator!(
    ManagementPlanOnBoardIndicator,
    "UBL CBC type: ManagementPlanOnBoardIndicator."
);
define_indicator!(
    MarkAttentionIndicator,
    "UBL CBC type: MarkAttentionIndicator."
);
define_indicator!(MarkCareIndicator, "UBL CBC type: MarkCareIndicator.");
define_indicator!(
    MedicalPractitionerConsultedIndicator,
    "UBL CBC type: MedicalPractitionerConsultedIndicator."
);
define_indicator!(
    MondayAvailabilityIndicator,
    "UBL CBC type: MondayAvailabilityIndicator."
);
define_indicator!(
    MoreIllThanExpectedIndicator,
    "UBL CBC type: MoreIllThanExpectedIndicator."
);
define_indicator!(
    NoFurtherNegotiationIndicator,
    "UBL CBC type: NoFurtherNegotiationIndicator."
);
define_indicator!(
    OptionalLineItemIndicator,
    "UBL CBC type: OptionalLineItemIndicator."
);
define_indicator!(
    OtherConditionsIndicator,
    "UBL CBC type: OtherConditionsIndicator."
);
...
define_indicator!(
    ...
    "UBL CBC type: PrivatePartyIndicator."
);
...
define_indicator!(
    ...
    "UBL CBC type: SSPSecurityMeasuresAppliedIndicator."
);
define_indicator!(
    SanitaryMeasuresAppliedIndicator,
    "UBL CBC type: SanitaryMeasuresAppliedIndicator."
);
define_indicator!(
    SaturdayAvailabilityIndicator,
    "UBL CBC type: SaturdayAvailabilityIndicator."
);
define_indicator!(
    ServiceProviderPartyIndicator,
    "UBL CBC type: ServiceProviderPartyIndicator."
);
define_indicator!(
    SickAnimalOnBoardIndicator,
    "UBL CBC type: SickAnimalOnBoardIndicator."
);
define_indicator!(
    SplitConsignmentIndicator,
    "UBL CBC type: SplitConsignmentIndicator."
);
define_indicator!(
    StatusAvailableIndicator,
    "UBL CBC type: StatusAvailableIndicator."
);
define_indicator!(StillIllIndicator, "UBL CBC type: StillIllIndicator.");
define_indicator!(
    StillOnBoardIndicator,
    "UBL CBC type: StillOnBoardIndicator."
);
define_indicator!(
    StowawaysFoundOnBoardIndicator,
    "UBL CBC type: StowawaysFoundOnBoardIndicator."
);
define_indicator!(
    SundayAvailabilityIndicator,
    "UBL CBC type: SundayAvailabilityIndicator."
);
...
define_indicator!(
    ...
    "UBL CBC type: ThursdayAvailabilityIndicator."
);
define_indicator!(
    TuesdayAvailabilityIndicator,
    "UBL CBC type: TuesdayAvailabilityIndicator."
);
define_indicator!(
    UnknownPriceIndicator,
    "UBL CBC type: UnknownPriceIndicator."
);
define_indicator!(ValidISSCIndicator, "UBL CBC type: ValidISSCIndicator.");
define_indicator!(
    ValidSanitationCertificateOnBoardIndicator,
    "UBL CBC type: ValidSanitationCertificateOnBoardIndicator."
);
define_indicator!(
    WednesdayAvailabilityIndicator,
    "UBL CBC type: WednesdayAvailabilityIndicator."
);
