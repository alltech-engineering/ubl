...
define_date!(
    EffectiveEndDate,
    "The date something ceases to be effective."
);
...
define_date!(
    ...
    "UBL CBC type: ComparisonForecastIssueDate."
);
define_date!(EarliestPickupDate, "UBL CBC type: EarliestPickupDate.");
define_date!(
    EstimatedDespatchDate,
    "UBL CBC type: EstimatedDespatchDate."
);
define_date!(
    FinalReexportationDate,
    "UBL CBC type: FinalReexportationDate."
);
define_date!(
    FirstShipmentAvailabilityDate,
    "UBL CBC type: FirstShipmentAvailabilityDate."
);
define_date!(
    FirstShipmentAvailibilityDate,
    "UBL CBC type: FirstShipmentAvailibilityDate."
);
...
define_date!(
    ...
    "UBL CBC type: LastDrinkingWaterAnalysisDate."
);
define_date!(
    LatestMeterReadingDate,
    "UBL CBC type: LatestMeterReadingDate."
);
define_date!(LatestPickupDate, "UBL CBC type: LatestPickupDate.");
define_date!(
    LatestProposalAcceptanceDate,
    "UBL CBC type: LatestProposalAcceptanceDate."
);
define_date!(
    LatestSecurityClearanceDate,
    "UBL CBC type: LatestSecurityClearanceDate."
);
define_date!(OnsetDate, "UBL CBC type: OnsetDate.");
define_date!(
    PreviousMeterReadingDate,
    "UBL CBC type: PreviousMeterReadingDate."
);
define_date!(
    RegistrationExpirationDate,
    "UBL CBC type: RegistrationExpirationDate."
);
...
define_date!(
    ...
    "UBL CBC type: SourceForecastIssueDate."
);
...
define_time!(
    ...
    "UBL CBC type: RequestedDespatchTime."
);
...
define_time!(
    ...
    "UBL CBC type: SourceForecastIssueTime."
);
