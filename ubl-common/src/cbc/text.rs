...
define_text!(
    ...
    "Previous meter reading method text."
);
...
define_text!(
    OrderableUnit,
    "The unit that an item can be ordered in (e.g., Each, Box)."
);
define_text!(
    CanonicalizationMethod,
    "The canonicalization method for a digital signature."
);
define_text!(
    SignatureMethod,
    "The signature method for a digital signature."
);
define_text!(
    ModificationReasonDescription,
    "A description of the reason for a modification."
);
...
define_name!(RetailEventName, "The name of a retail event.");
define_name!(OtherName, "A person's other/additional name.");
define_text!(Title, "A person's title (Mr, Mrs, Dr).");
define_text!(JobTitle, "A person's job title.");
define_name!(OrganizationName, "The name of an organization.");
define_text!(Department, "A department name.");
...
define_text!(BuildingNumber, "A building number.");
define_text!(Room, "A room number or name.");
define_text!(Floor, "A floor identifier.");
define_text!(Postbox, "A post office box number.");
define_name!(BlockName, "A block name.");
define_text!(District, "A district name.");
define_text!(Region, "A region/state/province name.");
...
define_text!(CertificateType, "A certificate type name.");
define_text!(Channel, "A channel name.");
define_text!(CompanyLegalForm, "A company legal form name.");
define_name!(ContractName, "A contract name.");
define_text!(ContractSubdivision, "A contract subdivision name.");
define_text!(CountrySubentity, "A country subentity name.");
define_name!(HolderName, "The name of a holder.");
define_text!(Location, "A location name.");
define_text!(PaymentNote, "A payment note.");
define_text!(PlotIdentification, "A plot identification.");
define_name!(Position, "A position name.");
define_text!(PostalZone, "A postal zone name.");
define_name!(RoleName, "A role name.");
define_name!(ServiceName, "A service name.");
define_text!(ShippingMarks, "Shipping marks.");
define_text!(Telephone, "A telephone number.");
define_name!(VesselName, "A vessel name.");
define_text!(XPath, "An XPath expression.");
...
define_text!(
    ...
    "An internal address referenced within a document."
);
...
define_text!(
    RegulatoryDomain,
    "The regulatory domain for a procurement procedure."
);
define_text!(
    WeightScoringMethodologyNote,
    "A note describing the weight scoring methodology."
);
define_name!(
    EconomicOperatorGroupName,
    "The name of an economic operator group."
);
...
define_text!(
    ...
    "UBL CBC type: AcceptedVariantsDescription."
);
...
define_text!(
    ...
    "UBL CBC type: AdditionalMattersDescription."
);
...
define_text!(
    ...
    "UBL CBC type: ConditionsDescription."
);
...
define_text!(
    ...
    "UBL CBC type: CourseOverGroundDirection."
);
...
define_text!(
    ...
    "UBL CBC type: CustomsClearanceServiceInstructions."
);
define_text!(
    DataSendingCapability,
    "UBL CBC type: DataSendingCapability."
);
define_text!(
    DemurrageInstructions,
    "UBL CBC type: DemurrageInstructions."
);
...
define_text!(
    ...
    "UBL CBC type: DocumentStatusReasonDescription."
);
...
define_text!(
    ...
    "UBL CBC type: ElectronicDeviceDescription."
);
...
define_text!(
    EmissionStandardReference,
    "UBL CBC type: EmissionStandardReference."
);
define_text!(
    EstimatedTimingFurtherPublication,
    "UBL CBC type: EstimatedTimingFurtherPublication."
);
...
define_text!(
    ...
    "UBL CBC type: ForwarderServiceInstructions."
);
...
define_text!(
    ...
    "UBL CBC type: GivenTreatmentDescription."
);
...
define_text!(
    ...
    "UBL CBC type: LowTendersDescription."
);
define_text!(
    MaintenanceFrequencyDescription,
    "UBL CBC type: MaintenanceFrequencyDescription."
);
...
define_text!(
    ...
    "UBL CBC type: MinimumImprovementBid."
);
...
define_text!(
    ...
    "UBL CBC type: NatureOfIllnessDescription."
);
define_text!(
    NegotiationDescription,
    "UBL CBC type: NegotiationDescription."
);
define_text!(
    NoControlActionsReason,
    "UBL CBC type: NoControlActionsReason."
);
...
define_text!(
    ...
    "UBL CBC type: OrganizationDepartment."
);
...
define_text!(
    ...
    "UBL CBC type: PaymentMeansDescription."
);
define_text!(
    PaymentOrderReference,
    "UBL CBC type: PaymentOrderReference."
);
...
define_text!(
    ...
    "UBL CBC type: PlannedInspectionsDescription."
);
define_text!(
    PlannedOperationsDescription,
    "UBL CBC type: PlannedOperationsDescription."
);
define_text!(
    PlannedWorksDescription,
    "UBL CBC type: PlannedWorksDescription."
);
define_text!(PriceChangeReason, "UBL CBC type: PriceChangeReason.");
define_text!(
    PriceRevisionFormulaDescription,
    "UBL CBC type: PriceRevisionFormulaDescription."
);
...
define_text!(
    ...
    "UBL CBC type: RecurringProcurementDescription."
);
define_text!(
    RegistrationNationality,
    "UBL CBC type: RegistrationNationality."
);
define_text!(
    ReplenishmentOwnerDescription,
    "UBL CBC type: ReplenishmentOwnerDescription."
);
...
define_text!(
    ResourceOriginDescription,
    "UBL CBC type: ResourceOriginDescription."
);
...
define_text!(
    ...
    "UBL CBC type: SickAnimalDescription."
);
define_text!(
    SpecialFormDescription,
    "UBL CBC type: SpecialFormDescription."
);
define_text!(
    SpecialServiceInstructions,
    "UBL CBC type: SpecialServiceInstructions."
);
define_text!(
    SpecialTransportRequirements,
    "UBL CBC type: SpecialTransportRequirements."
);
...
define_text!(
    ...
    "UBL CBC type: TechnicalCommitteeDescription."
);
define_text!(
    TelecommunicationsServiceCall,
    "UBL CBC type: TelecommunicationsServiceCall."
);
define_text!(
    TelecommunicationsServiceCategory,
    "UBL CBC type: TelecommunicationsServiceCategory."
);
define_text!(
    TelecommunicationsSupplyType,
    "UBL CBC type: TelecommunicationsSupplyType."
);
...
define_text!(
    ...
    "UBL CBC type: TransportServiceProviderSpecialTerms."
);
define_text!(TransportUserRemarks, "UBL CBC type: TransportUserRemarks.");
define_text!(
    TransportUserSpecialTerms,
    "UBL CBC type: TransportUserSpecialTerms."
);
define_text!(
    TransportationServiceDescription,
    "UBL CBC type: TransportationServiceDescription."
);
...
define_text!(
    ...
    "UBL CBC type: WeightingConsiderationDescription."
);
