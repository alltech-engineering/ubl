...
define_identifier!(
    ID,
    "A generic identifier. The primary identifier for many UBL elements."
);
...
define_identifier!(
    ...
    "A goods item passport counterfoil identifier."
);
define_identifier!(CompanyID, "A company registration identifier.");
define_identifier!(
    CustomerAssignedAccountID,
    "An account ID assigned by the customer."
);
define_identifier!(
    SupplierAssignedAccountID,
    "An account ID assigned by the supplier."
);
...
define_identifier!(
    ConsigneeAssignedID,
    "An identifier assigned by the consignee."
);
define_identifier!(
    ConsignorAssignedID,
    "An identifier assigned by the consignor."
);
define_identifier!(
    ContractedCarrierAssignedID,
    "An identifier assigned by a contracted carrier."
);
...
define_identifier!(
    ProfileExecutionID,
    "An identifier for a profile execution instance."
);
...
define_identifier!(
    PreviousDocumentID,
    "An identifier for a previous document version."
);
define_identifier!(
    OriginalDocumentID,
    "An identifier for the original document."
);
...
define_identifier!(
    ...
    "A certificate reference identifier."
);
...
define_identifier!(
    ...
    "An immobilization certificate identifier."
);
...
define_identifier!(
    ...
    "A registration nationality identifier."
);
define_identifier!(
    SequenceNumberID,
    "A sequence number identifier (e.g., for order change sequencing)."
);
define_identifier!(
    UBLVersionID,
...
define_identifier!(
    ...
    "UBL CBC type: BusinessClassificationEvidenceID."
);
define_identifier!(
    BusinessIdentityEvidenceID,
    "UBL CBC type: BusinessIdentityEvidenceID."
);
...
define_identifier!(
    ...
    "UBL CBC type: EconomicOperatorRegistryURI."
);
...
define_identifier!(
    ...
    "UBL CBC type: FreightForwarderAssignedID."
);
...
define_identifier!(
    ...
    "UBL CBC type: LowerOrangeHazardPlacardID."
);
...
define_identifier!(
    ...
    "UBL CBC type: OriginalContractingSystemID."
);
define_identifier!(OriginalJobID, "UBL CBC type: OriginalJobID.");
define_identifier!(
    ParentDocumentLineReferenceID,
    "UBL CBC type: ParentDocumentLineReferenceID."
);
define_identifier!(
    ParentDocumentVersionID,
    "UBL CBC type: ParentDocumentVersionID."
);
...
define_identifier!(
    ...
    "UBL CBC type: ReferencedConsignmentID."
);
define_identifier!(
    RequestForQuotationLineID,
    "UBL CBC type: RequestForQuotationLineID."
);
define_identifier!(ResponseURI, "UBL CBC type: ResponseURI.");
define_identifier!(
    RevisedForecastLineID,
    "UBL CBC type: RevisedForecastLineID."
);
...
define_identifier!(
    TrailerLicensePlateID,
    "UBL CBC type: TrailerLicensePlateID."
);
define_identifier!(TrainID, "UBL CBC type: TrainID.");
define_identifier!(
    TransportExecutionPlanReferenceID,
    "UBL CBC type: TransportExecutionPlanReferenceID."
);
define_identifier!(
    TransportationServiceDetailsURI,
    "UBL CBC type: TransportationServiceDetailsURI."
);
define_identifier!(TypeID, "UBL CBC type: TypeID.");
define_identifier!(
    UpperOrangeHazardPlacardID,
    "UBL CBC type: UpperOrangeHazardPlacardID."
);
define_identifier!(
    ValidatedCriterionPropertyID,
    "UBL CBC type: ValidatedCriterionPropertyID."
);
